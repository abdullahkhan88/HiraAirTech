...
const OurClient = () => {
  return (
    ...
    >
      ...
      {/* Text on Image */}
      <div className="absolute top-12 md:top-55 left-0 md:left-50 max-w-2xl md:max-w-4xl px-6">
        <h2 className="text-xl px-4 md:px-0 md:text-5xl tracking-tight font-semibold mb-1 md:mb-3 text-[#004fa6]">
          Our Clients
        </h2>
