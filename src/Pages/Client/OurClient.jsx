  ...
  return (
    <section
      className="relative max-w-xl md:max-w-7xl mx-auto w-full
                 min-h-[40vh] md:min-h-[90vh] lg:min-h-screen
    ...
    >
      ...
      {/* Text on Image */}
      <div className="absolute top-55 left-50 max-w-4xl px-6">
        <h2 className="text-2xl md:text-5xl tracking-tight font-semibold mb-3 text-[#004fa6]">
          Our Clients
        </h2>

        <p className="text-sm md:text-2xl leading-tight text-gray-700 mt-10">
